...
def test_add_branch(base_url, selenium, bugzilla_host):
    ...
    experiment.bugzilla_url = f"{bugzilla_host}show_bug.cgi?id=1234"
...
@pytest.mark.nondestructive
def test_remove_branch(base_url, selenium, bugzilla_host):
...
@pytest.mark.nondestructive
def test_duplicate_branch_name(base_url, selenium, bugzilla_host):
